      ...
      <div ref={scrollRef}>
        {sections.map((sec, index) => {
          ...
          return (
            <section
              key={index}
              className="relative w-full h-[500px] sm:h-[550px] md:h-[600px] my-12 md:my-20 overflow-hidden group"
            >
              {/* Background Image */}
              <img
                src={sec.img}
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-black/40 to-black/20 group-hover:from-black/50 group-hover:to-black/30 transition duration-700"></div>
